...
<!-- ====================== PAGE HERO ====================== -->
    <section class="s-page-hero" data-section="page-hero" aria-label="ページ見出し">
      ...
      <div class="l-container s-page-hero__inner">
        ...
        <p class="s-page-hero__sub js-fade">7つのお風呂と2つのサウナ。芯から、ととのえる。</p>
        <nav aria-label="パンくず">
    ...
    <section class="s-block s-block--alt" data-section="bath-list" aria-label="お風呂一覧">
      <div class="l-container">
        ...
        <div class="c-bath-grid">
          ...
          <article class="c-bath-card js-fade">
            <div class="c-bath-card__media">
              <img src="https://www.kawasaki-big.com/spa_sauna/img/img03.jpg" alt="薬風呂の様子" loading="lazy" decoding="async" width="800" height="600" />
            </div>
            <div class="c-bath-card__body">
          ...
          <article class="c-bath-card js-fade">
            <div class="c-bath-card__media">
              <img src="https://www.kawasaki-big.com/spa_sauna/img/img04.jpg" alt="ラドン風呂の様子" loading="lazy" decoding="async" width="800" height="600" />
            </div>
            <div class="c-bath-card__body">
