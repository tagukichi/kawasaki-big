...
function kb_get_services_cards() {
    ...
    return [
        ...
        ['image' => kb_img('img03-03.jpg'), 'num' => '03', 'title' => 'ボディケア', 'description' => '日々の疲れを、専門の手で。2F・11:00〜翌3:30。', 'link_url' => home_url('/bodycare/')],
        ['image' => kb_img('0T8A4965.JPG'), 'num' => '04', 'title' => '館内案内',   'description' => '7フロアにわたる、休息のためのすべて。',                              'link_url' => home_url('/floor/')],
    ];
}
